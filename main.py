...
BOT_TOKEN = "7250167805:AAHycgfD828b09AUjJcE4EbIEnN5GfgJsMA"
PAYMENT_CHANNEL = "@free011111" #add payment channel here including the '@' sign
OWNER_ID = 7354011839 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@free011111"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
              #you can add as many channels here and also add the '@' sign before channel username
Daily_bonus = 200 #Put daily bonus amount here!
Mini_Withdraw = 5000  #remove 0 and add the minimum withdraw u want to set
Per_Refer = 200 #add per refer bonus here
